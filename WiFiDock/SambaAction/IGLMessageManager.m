...
-(void)main{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        IGLNotifyHUD *_notify = [IGLNotifyHUD notifyHUDWithImage:nil text:_message];
        ...
        _notify.center =center;
        
        
        [[UIApplication sharedApplication].keyWindow addSubview:_notify];
        [[UIApplication sharedApplication].keyWindow bringSubviewToFront:_notify];
        [_notify presentWithDuration:0.5f speed:0.5f inView:[UIApplication sharedApplication].keyWindow completion:^{
            dispatch_async(dispatch_get_main_queue(), ^{
