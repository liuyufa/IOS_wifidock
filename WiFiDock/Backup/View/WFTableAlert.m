...
@interface WFTableAlert()<UITableViewDataSource, UITableViewDelegate>
...
@property (nonatomic, strong) WFTableAlertNumberOfRowsBlock numberOfRows;
@property (nonatomic, strong) WFTableAlertTableCellsBlock cells;
...
-(id)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle numberOfRows:(WFTableAlertNumberOfRowsBlock)rowsBlock andCells:(WFTableAlertTableCellsBlock)cellsBlock
{
