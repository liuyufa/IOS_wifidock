...
@interface WFContactPickerView ()<UIScrollViewDelegate,WFContactBubbleDelegate,UITextViewDelegate>

@property (nonatomic,assign)BOOL shouldSelectTextView;
@property (nonatomic, strong) UIScrollView *scrollView;
@property (nonatomic, strong) NSMutableDictionary *contacts;
@property (nonatomic, strong) NSMutableArray *contactKeys;
@property (nonatomic, strong) UILabel *placeholderLabel;
@property (nonatomic, assign) CGFloat lineHeight;
@property (nonatomic, strong) UITextView *textView;

@property (nonatomic, strong) WFBubbleColor *bubbleColor;
@property (nonatomic, strong) WFBubbleColor *bubbleSelectedColor;

@end

@implementation WFContactPickerView
...
- (void)setup {
    ...
    WFContactBubble *contactBubble = [[WFContactBubble alloc] initWithName:@"Sample"];
...
- (void)addContact:(id)contact withName:(NSString *)name {
    ...
    WFContactBubble *contactBubble = [[WFContactBubble alloc] initWithName:name color:self.bubbleColor selectedColor:self.bubbleSelectedColor];
    if (self.font != nil){
...
- (void)removeAllContacts
{
    for(id contact in [self.contacts allKeys]){
        WFContactBubble *contactBubble = [self.contacts objectForKey:contact];
...
- (void)removeContact:(id)contact {
    ...
    WFContactBubble *contactBubble = [self.contacts objectForKey:contactKey];
    [contactBubble removeFromSuperview];
...
- (void)setBubbleColor:(WFBubbleColor *)color selectedColor:(WFBubbleColor *)selectedColor {
    ...
    for (id contactKey in self.contactKeys){
        WFContactBubble *contactBubble = (WFContactBubble *)[self.contacts objectForKey:contactKey];
...
- (void)removeContactBubble:(WFContactBubble *)contactBubble {
...
- (id)contactForContactBubble:(WFContactBubble *)contactBubble {
...
#pragma mark - WFContactBubbleDelegate Functions
