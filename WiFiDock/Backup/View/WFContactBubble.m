...
@interface WFContactBubble()<UITextViewDelegate>

@end

@implementation WFContactBubble
...
- (id)initWithName:(NSString *)name color:(WFBubbleColor *)color selectedColor:(WFBubbleColor *)selectedColor {
    self = [super init];
    if (self){
        self.name = name;
        self.isSelected = NO;
        ...
        if (color == nil){
            color = [[WFBubbleColor alloc] initWithGradientTop:kBubbleColor gradientBottom:kBubbleColor border:kBubbleColor];
        }
        
        if (selectedColor == nil){
            selectedColor = [[WFBubbleColor alloc] initWithGradientTop:kBubbleColorSelected gradientBottom:kBubbleColorSelected border:kBubbleColorSelected];
        }
