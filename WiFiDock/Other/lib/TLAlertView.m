...
- (void)executeCompletionBlock:(UIButton *)sender {
    ...
    CGFloat degree = (TLAnimationType3D) ? 180.0 : 0.0;
...
- (void)layoutSubviews {
    ...
    self.confirmButton.backgroundColor =[UIColor colorWithRed:0.000 green:0.502 blue:1.000 alpha:1.000];
    self.cancelButton.backgroundColor = [UIColor colorWithRed:0.000 green:0.502 blue:1.000 alpha:1.000];
