...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
    ...
    filePath = [SAMBA_URL stringByAppendingString:filePath];
    ...
    id result = [provider fetchAtPath:filePath];
    if (!result) {
        return nil;
    }
    if([result isKindOfClass:[IGLSMBItemFile class]]){
        return [[HttpSambaFileResponse alloc] initWithFile:result forConnection:self];
    }
    return nil;
